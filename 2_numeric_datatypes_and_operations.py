...
int and float deal with integers and decimals whereas complex deals with complex/imaginary
numbers.
...
# In case of multiple operators occurring in an expression then operator precedence comes
